...
| [5.py](./5.py) | Resuelve el problema de las inversiones en un array y hace una simulación. |
| [6a_solucion.md](./6a_solucion.md) | Demuestra la fórmula P(I_k) = 1 / k! |
...
- Problema 5: la resolución del problema de contar las inversiones en un array.
